...
def get_args(description='Text-Video Retrieval.'):
    ...
    parser.add_argument('--beta', type=float, default=0.0001, help='Hyperparameter beta.')
    parser.add_argument('--gamma', type=float, default=0.0001, help='Hyperparameter gamma.')
