...
class local_merge(nn.Module):
    def __init__(self, n_h, d_in, d_out, d_h, dropout=0.0):
        super(local_merge, self).__init__()

        self.num_head = n_h
        self.attention = MultiHeadSelfAttention(n_h, d_in, d_h)
    ...
    def forward(self, global_feat, local_feat, pad_mask=None):
